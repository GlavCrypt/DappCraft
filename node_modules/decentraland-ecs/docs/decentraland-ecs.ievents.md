...
|  [`onEnter`](./decentraland-ecs.ievents.onenter.md) | `{}` | `onEnter` is triggered when the user hits the "Enter" key from the keyboard Used principally by the Chat internal scene |
