...
items:
  - uid: decentraland-ecs.Input
    ...
    children:
      - decentraland-ecs.Input.ensureInstance
  ...
  - uid: decentraland-ecs.Input.ensureInstance
    name: ensureInstance()
    fullName: ensureInstance
    langs:
      - typeScript
    type: method
    syntax:
      content: 'static ensureInstance(): any;'
      return:
        type:
          - any
        description: ''
  ...
  - uid: decentraland-ecs.Input.subscribe
    ...
    syntax:
      content: >-
        subscribe(eventName: InputEventKind, fn: (e: LocalPointerEvent) => void): () => false | ((e: LocalPointerEvent)
        => void)[];
      return:
        type:
  ...
  - uid: decentraland-ecs.Input.unsubscribe
    ...
    syntax:
      content: >-
        unsubscribe(eventName: InputEventKind, fn: (e: LocalPointerEvent) => void): false | ((e: LocalPointerEvent) =>
        void)[];
      return:
        type:
          - 'false | ((e: LocalPointerEvent) => void)[]'
